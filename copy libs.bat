cd C:\Users\Robert\Desktop\WORK\Caravansary\Caravansary\bin\Debug\x64\net5.0-windows\Modules
del "*.dll" /s 
REM c:\windows\system32\xcopy C:\Users\Robert\Desktop\WORK\MainBar\MainBar\bin\Debug\net5.0-windows\MainBar.dll "MainBar\" /e
